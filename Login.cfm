        ...
        <cfoutput>
            <div class="d-flex accessPageHead justify-content-between py-2">
                ...
                <div class="d-flex me-5">
                    <div class="me-4">
                        <a class="accessNames" href="./signUp.cfm">
                            <img src="./Assets/Images/signup.png"> Sign Up
                        </a>
                    </div>
                    <div>
                        <a class="accessNames" href="./Login.cfm">
                            <img height="20" src="./Assets/Images/login.png"> Login
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div>Don't have an account? 
                                            <a class="registerClass" href="./signUp.cfm">Register Here</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
